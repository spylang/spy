...
def w_gc_alloc(vm: 'SPyVM', w_T: W_Type) -> W_Dynamic:
    ...
    @no_type_check
    @builtin_func(w_ptrtype.qn, 'gc_alloc')  # unsafe::ptr[i32]::gc_alloc
...
def w_mem_read(vm: 'SPyVM', w_T: W_Type) -> W_Dynamic:
    ...
    @no_type_check
    @builtin_func('unsafe', 'mem_read', [w_T.qn])  # unsafe::mem_read[i32]
...
def w_mem_write(vm: 'SPyVM', w_T: W_Type) -> W_Dynamic:
    ...
    @no_type_check
    @builtin_func('unsafe', 'mem_write', [w_T.qn])  # unsafe::mem_write[i32]
